function plot_3D_stationary_drone(location, euler_angles, armlength, handles)
    ...
    plot_3D_orientation(location,euler_angles,armlength, handles); % Plots orientation of centre point
